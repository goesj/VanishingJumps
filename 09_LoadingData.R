...
######################### UK WAR DATA ##########################################
#Liu, Li Data
EnglandDeaths <- read.table(file = file.path(getwd(),"Data/Deaths_5x1_EnglandWales.txt"),
                            header = TRUE)
EnglandExp <- read.table(file = file.path(getwd(),"Data/Exposures_5x1_EnglandWales.txt"),
                         header = TRUE)
